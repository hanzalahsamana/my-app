                ...
                <div className="flex w-full justify-between">
                    ...
                    <div>
                        <div class="flex space-x-2 justify-center">
                            <button type="button" class="inline-block md:w-64	 w-80 rounded-3xl px-14 py-4 bg-blue-700 text-white font-medium text-xs leading-tight uppercase  shadow-md hover:bg-blue-800 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800 active:shadow-lg transition duration-150 ease-in-out">Post</button>
                        </div>
                    </div>
                </div>
            </div>
