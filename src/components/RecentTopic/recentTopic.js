                            ...
                            <nav aria-label="Page navigation example">
                                <ul class="flex list-style-none">
                                    ...
                                    <li class="page-item"><a
                                        ...
                                        href="#">1 of 16</a></li>
                                    <li class="page-item"><a
                                        class="page-link relative block py-1 px-3 rounded border-0 bg-transparent outline-none transition-all duration-300 rounded text-blue-800 hover:text-gray-800 hover:bg-gray-200 focus:shadow-none"
